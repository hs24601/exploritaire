...
export const SolarisPrimeAtmosphere = memo(function SolarisPrimeAtmosphere({ className }: Props) {
  ...
  useEffect(() => {
    ...
    const colors = {
      core: new THREE.Color(1.0, 0.9, 0.7),
      shell: new THREE.Color(1.0, 0.55, 0.1),
      diskA: new THREE.Color(1.0, 0.65, 0.1),
      diskB: new THREE.Color(0.98, 0.25, 0.08),
      ring: new THREE.Color(1.0, 0.5, 0.18),
      emberA: new THREE.Color(1.0, 0.95, 0.8),
      emberB: new THREE.Color(1.0, 0.55, 0.05),
      prominence: new THREE.Color(1.0, 0.65, 0.1),
    };
    ...
    disposableGeometries.push(ringGeom);
    ...
    disposableGeometries.push(diskGeom);
    ...
    disposableGeometries.push(emberGeom);
    ...
    disposableGeometries.push(prominenceGeom);
    ...
    for (let i = 0; i < starfieldCount; i += 1) {
      ...
      starfieldPos[i * 3] = r * Math.sin(ph) * Math.cos(th);
      starfieldPos[i * 3 + 1] = r * Math.cos(ph);
      starfieldPos[i * 3 + 2] = r * Math.sin(ph) * Math.sin(th);
    }
    ...
    disposableGeometries.push(starfieldGeom);
