...
export const GargantuaAtmosphere = memo(function GargantuaAtmosphere({ className }: Props) {
  ...
  useEffect(() => {
    ...
    const camera = new THREE.PerspectiveCamera(60, mount.clientWidth / mount.clientHeight, 0.1, 4000);
    ...
    controls.rotateSpeed = 0.4; controls.autoRotate = true; // Default to ON for atmosphere
