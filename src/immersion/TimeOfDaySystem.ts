...
export class TimeOfDaySystem {
    private hour: number = 12; // 0-24
    private speed: number = 0.1; // hours per real second
    ...
    public update(deltaMs: number): LightingState {
        ...
        return {
            ...
            ambientIntensity,
            ambientColor,
            rainDelta: 0 // Will be driven by weather system later
        };
    }
