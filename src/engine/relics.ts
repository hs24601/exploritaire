...
export const RELIC_DEFINITIONS: RelicDefinition[] = [
  ...
  },
  {
    id: 'final_move',
    name: 'Final Move',
    description: 'If the timer expires while dragging a card, your turn is held open until that drag resolves.',
    rarity: 'rare',
    passive: true,
    scope: 'party',
    behaviorId: 'final_move_v1',
    params: {},
  },
  {
    id: 'master_strategist',
    name: 'Master Strategist',
    description: 'Time fully pauses while you are actively dragging a card.',
    rarity: 'mythic',
    passive: true,
    scope: 'party',
    behaviorId: 'master_strategist_v1',
    params: {},
  },
  {
    id: 'zen',
    name: 'Zen',
    description: `Breathe deep. Adds an "end turn" button to end your turn. No time limits.`,
    rarity: 'rare',
    passive: true,
    scope: 'party',
    behaviorId: 'zen_v1',
